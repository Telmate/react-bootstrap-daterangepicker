  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        updateMonthYear: function (e) {
            ...
            // If new month/year is outside of min/max range, move to closest valid month
            var newMonthYear = moment({ years:year, months:month, date:1 });
            if(newMonthYear.startOf('month') > this.maxDate) {
                month = this.maxDate.month();
            }
            if(newMonthYear.endOf('month') < this.minDate) {
        ...
        buildCalendar: function (month, year, hour, minute, side) {
            ...
            var firstDay = moment([year, month, 1]).startOf('day');
            var lastDay = moment([year, month, daysInMonth]).endOf('day');
