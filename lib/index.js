...
module.exports = React.createClass({
  $picker: null,
  options: [
    'startDate', 'endDate', 'minDate', 'maxDate', 'dateLimit', 'showDropdowns',
    'showWeekNumbers', 'timePicker', 'timePicker12Hour', 'timePickerIncrement',
    'timePickerSeconds', 'timeZone', 'ranges', 'opens', 'buttonClasses',
    'applyClass', 'cancelClass', 'format', 'separator', 'locale',
    'singleDatePicker', 'parentEl'
  ],
